...
> 일정 (2026-08-19 2차 재조정 — AI Summit 참가로 8/19~8/20 작업 공백): Day 0 = 8/11(화), Day 1~2 = 8/12~13, Day 3 = 8/14~8/16(일), Day 4 = 8/18(화) → **Day N≥5 = 8/16+N: Day 5 = 8/21(금)**, Day 9 = 8/25(화), Day 14 = 8/30(일), Day 19 = 9/4(금), 9/5~9/7 버퍼, **Day 20 런칭 = 9/8(화)**, Day 21 = 9/9(수) 버퍼, 판정일 9/22(화)
