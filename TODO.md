...
> 일정: Day 0 = 2026-08-12(수) 기준 → Day 1 = 8/13(목), Day 20 런칭 = 9/1(화) ✓ 화~목 규칙 충족
> (Day 0 세팅은 8/11에 선행 완료)
...
- [ ] 오전: 발산 15개 (3소스 × 5개)
- [ ] 정오: 4기준 스코어링 → 상위 2~3개
- [ ] 오후: 웹 검색 검증 → 최종 1개 확정 + 산출물 5개 (언어·시장 / 킬 크라이테리아 / 중점 축 / 유입 전략 / 플랫폼 판정)
- [ ] /grill-me 1회 → 서비스명 확정 → 도메인 구매
